...
public class MainUI extends UI {
    ...
    private MGrid<Employee> list = new MGrid<>(Employee.class)
            .withProperties("id", "name", "email", "phoneNumber", "jobTitle")
            .withColumnHeaders("id", "Name", "Email", "Phone", "Job Title")
            .withFullWidth();
    ...
    private Button delete = new ConfirmButton(VaadinIcons.FILE_REMOVE,
            "Are you sure you want to delete the employee?", this::remove);
    ...
    protected void init(VaadinRequest request) {
        DisclosurePanel aboutBox = new DisclosurePanel("Easy CRUD app with Vaadin GUI and API support", new RichText().withMarkDownResource("/welcome.md"));
        setContent(
                new MVerticalLayout(
